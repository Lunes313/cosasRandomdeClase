...
public class Semana12ej7 {
    public static int busquedaBinaria(ArrayList<Integer> lista, int valor, int inicio, int fin){
        if(fin >= inicio){
    ...
    public static void main(String[] args) {
        ...
        int valor = sc.nextInt();
        int posicion = busquedaBinaria(lista, valor, 0, lista.size() - 1);
        if(posicion == -1){
